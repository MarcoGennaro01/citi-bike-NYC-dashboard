...
scatter_prcp.write_html("../html/plots_weather_prcp.py")
scatter_wspd.write_html("../html/plots_weather_wspd.py")
scatter_temp.write_html("../html/plots_weather_temp.py")
